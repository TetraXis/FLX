...
//		FLX_OPT_FORCED_COMPILER_*	- for forcing compiler
//		FLX_OPT_FORCED_ARCH_*		- for forcing architecture
//		FLX_OPT_FORCED_OS_*			- for forcing operating system
//		FLX_OPT_FORCED_CRT_*		- for forcing C Runtime
