...
#define FLX_ENV_COMPILER_MSVC		3
	...
	#error "Unsupported compiler. As of writing this lib, only GCC and Clang support C++26."
#endif
...
#define FLX_ENV_CRT_ANDROID	7
	...
	// TODO: Test this detection later on Linux, where CRT maybe linked later in the pipeline.
