...
namespace test
{
	inline void type_traits()
	{
		...
		// ===== is_same ===== //
		{
			...
			check(flx::is_same<std::string, std::string> == std::is_same_v<std::string, std::string>, "Mismatch with STD 09");
			check(flx::is_same<const volatile int, const volatile int> == std::is_same_v<const volatile int, const volatile int>, "Mismatch with STD 0A");
		...
		// ===== remove_cv ===== //
		{
			...
			check(std::is_same_v<flx::remove_cv<const int[5]>, std::remove_cv_t<const int[5]>>, "Mismatch with STD 0C");
			check(std::is_same_v<flx::remove_cv<volatile int[5]>, std::remove_cv_t<volatile int[5]>>, "Mismatch with STD 0D");
			check(std::is_same_v<flx::remove_cv<const volatile int[5]>, std::remove_cv_t<const volatile int[5]>>, "Mismatch with STD 0E");
			check(std::is_same_v<flx::remove_cv<void>, std::remove_cv_t<void>>, "Mismatch with STD 0F");
			check(std::is_same_v<flx::remove_cv<const void>, std::remove_cv_t<const void>>, "Mismatch with STD 10");
			check(std::is_same_v<flx::remove_cv<int&>, std::remove_cv_t<int&>>, "Mismatch with STD 11");
			check(std::is_same_v<flx::remove_cv<const int&>, std::remove_cv_t<const int&>>, "Mismatch with STD 12");
			check(std::is_same_v<flx::remove_cv<int&&>, std::remove_cv_t<int&&>>, "Mismatch with STD 13");
			check(std::is_same_v<flx::remove_cv<enum E>, std::remove_cv_t<enum E>>, "Mismatch with STD 14");
